...
export async function fillPdfTemplate(
  ...
  try {
    const formUrl =
      "https://utfs.io/f/9d368e58-22e1-49eb-8028-6642f1ba156e-457idv.pdf";
    ...
    for (const { tenantName, unitNumber } of tenants) {
      ...
      form.getCheckBox("signed_by_checkbox").check();
      form.getCheckBox("signed_by_checkbox").defaultUpdateAppearances();
